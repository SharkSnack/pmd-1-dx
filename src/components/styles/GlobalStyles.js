...
export const baseStyles = css`
  ...
  * {
  ...
  .wonderMailItems td:nth-of-type(2) {
    background-color: #f7f7f7;
  }
  .wonderMailItems td:nth-of-type(3) {
    min-width: 130px;
  }
  .wonderMailItems td:nth-of-type(4) {
    text-align: left;
  }
  .wonderMailItems img {
    vertical-align: text-top !important;
  ...
  .wonderMailPokemon th {
    font-weight: normal;
    text-align: center;
  }
  .wonderMailPokemon td {
    text-align: center;
    padding-left: 4px;
    padding-right: 4px;
  }
  ...
  .moveTable td:nth-of-type(1){
    text-align: left;
    background-color: #f7f7f7;
  }
  .moveTable td:nth-of-type(8){
    max-width: 400px;
    text-align: left;
  }
  .TMTable img {
  ...
  .TMTable td:nth-of-type(1){
    text-align: left;
    background-color: #f7f7f7;
  }
  .TMTable td:nth-of-type(2){
    text-align: center;
  }
  .TMTable td:nth-of-type(7){
    text-align: left;
  }
  .tableNotes p {
    font-size: 13px;
